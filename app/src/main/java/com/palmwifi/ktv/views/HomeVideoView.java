...
public class HomeVideoView extends GSYVideoPlayer {
     ...
     */
    public HomeVideoView(Context context, Boolean fullFlag) {
    ...
    public HomeVideoView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
    ...
    public int getLayoutId() {
        if (mIfCurrentIsFullscreen) {
            return com.palmwifi.ktv.R.layout.sample_video_land;
        }
        return com.palmwifi.ktv.R.layout.layout_video_home;
    }
    ...
    private void changeUiToPrepareingShow() {
        ...
        mStartButton.setVisibility(mIfCurrentIsFullscreen ?View.VISIBLE:View.INVISIBLE);
    ...
    public GSYBaseVideoPlayer startWindowFullscreen(Context context, boolean actionBar, boolean statusBar) {
        ...
        if (gsyBaseVideoPlayer != null) {
            HomeVideoView gsyVideoPlayer = (HomeVideoView) gsyBaseVideoPlayer;
     ...
     * 全屏的UI逻辑
     */
    private void initFullUI(HomeVideoView standardGSYVideoPlayer) {
    ...
    protected void hideAllWidget() {
        mBottomContainer.setVisibility(mIfCurrentIsFullscreen ?VISIBLE :View.INVISIBLE);
        mTopContainer.setVisibility(View.INVISIBLE);
        mBottomProgressBar.setVisibility(View.VISIBLE);
        mStartButton.setVisibility(mIfCurrentIsFullscreen ?View.VISIBLE:View.INVISIBLE);
    }
