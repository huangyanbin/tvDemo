...
public class FullVideoView extends GSYVideoPlayer {
    ...
    private BallView mLoadingProgressBar;
    ...
    protected void init(Context context) {
        ...
        mLoadingProgressBar = (BallView) findViewById(com.shuyu.gsyvideoplayer.R.id.loading);
