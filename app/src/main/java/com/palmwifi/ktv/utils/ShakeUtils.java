...
public class ShakeUtils {
    ...
    public static void simpleShakeBgPropertyAnim(View view,float defaultScaleSize){
        startShakeByPropertyAnim(view,defaultScaleSize, defaultScaleSize-0.05f, defaultScaleSize, 3f, 200);
    ...
    public static void startShakeByPropertyAnim(View view,float defaultScale, float scaleSmall, float scaleLarge, float shakeDegrees, long duration) {
        if (view == null) {
            return;
        }
        ...
        //先变小后变大
        PropertyValuesHolder scaleXValuesHolder = PropertyValuesHolder.ofKeyframe(View.SCALE_X,
                Keyframe.ofFloat(0f, defaultScale),
                Keyframe.ofFloat(0.25f, scaleSmall),
                Keyframe.ofFloat(0.5f, scaleLarge),
                Keyframe.ofFloat(0.75f, scaleLarge),
                Keyframe.ofFloat(1f, defaultScale)
        );
        PropertyValuesHolder scaleYValuesHolder = PropertyValuesHolder.ofKeyframe(View.SCALE_Y,
                Keyframe.ofFloat(0f, defaultScale),
                Keyframe.ofFloat(0.25f, scaleSmall),
