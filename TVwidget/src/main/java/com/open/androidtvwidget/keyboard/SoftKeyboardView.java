...
public class SoftKeyboardView extends View {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        mPressBgPaint = new Paint(Paint.ANTI_ALIAS_FLAG);
        mPressBgPaint.setStyle(Paint.Style.FILL);
        mPressBgPaint.setColor(Color.parseColor("#54aeff"));
    ...
    private void drawSoftKeySelectState(Canvas canvas, SoftKey softKey) {
        ...
        canvas.drawRoundRect(rectF,12,12,mPressBgPaint);
